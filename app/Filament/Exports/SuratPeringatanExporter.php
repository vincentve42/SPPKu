...
class SuratPeringatanExporter extends Exporter
{
    ...
    public static function getColumns(): array
    {
        return [
            ...
            ExportColumn::make('surat')->label('Surat Ke Berapa'),
    ...
    {
        $body = 'Your surat peringatan export has completed and ' . number_format($export->successful_rows) . ' ' . str('row')->plural($export->successful_rows) . ' exported.';
